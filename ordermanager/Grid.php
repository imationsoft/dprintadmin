 	...
 	protected function _prepareLayout()
{
    ...
    protected function _prepareCollection()
    {
        ...
        return $collection;//parent::_prepareCollection();
    }
 ...
 */
        ...
        $this->addColumn('status', array(
            ...
            'type'  => 'options',
            'width' => '70px',
            'options' => array('approved'=>'Approved','pending'=>'pending'),//Mage::getSingleton('sales/order_config')->getStatuses(),//added by Wang2015-7-2
        ));
