 ...
 */
        ...
        $this->addColumn('status', array(
            ...
            'type'  => 'options',
            'width' => '70px',
            'options' => array('approved'=>'Approved','pending'=>'pending','rejected'=>'Rejected','canceled'=>'Canceled','closed'=>'Closed','processing'=>'Processing'),//Mage::getSingleton('sales/order_config')->getStatuses(), //added by Wang 2015-7-7
        ));
